...
class ListProducto
{
    ...
    protected function addWoocommerceViewTab() {
        return function() {
            // Añadimos una pestaña a la vista de WooCommerce.
            $viewName = 'woocommerce';
            $this->addView($viewName, 'woocommerce_tab', 'WooCommerce TAB', 'fas fa-cubes');
        };
